...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name = "flatten"), fc(20, 10, name = "fc"), relu(name = "relu")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(4,30, name = "fc1"), relu(name = "relu"),fc(30,7, name = "fc2")
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ...
            fc(3072, 90, init_scale = 5e-4, name = "fc1"),
            relu(name = "relu"),
            fc(90, 10, init_scale = 5e-4,name = "fc2")
            ########### END ###########
        )
